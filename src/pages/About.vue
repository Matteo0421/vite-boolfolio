  ...
  <main class="flex-shrink-0">
    ...
    <div class="container px-5 my-5">
      <div class="text-center mb-5">
        <h1 class="display-5 fw-bolder mb-0"><span class="">About me</span></h1>
      </div>
                  ...
                  <div class="col text-center text-lg-start mb-4 mb-lg-0">
                    <div class="bg-light p-4 rounded-4">
                      ...
                      <div class="fst-italic">
                        <div class="small text-muted">Web Development full-stack</div>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-8">
                    <div>
                      Corso di formazioni per acquisire capacita e skills sul mondo della programmazione
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card shadow border-0 rounded-4 mb-5">
              <div class="card-body p-5">
                <div class="row align-items-center gx-5">
                  ...
                  <div class="col-lg-8">
                    <div>
                      Istituto tecnico con l'obbiettivo di formare su tematiche come l'informatica e l'economia
                      aziendale
                    </div>
                  </div>
                </div>
            ...
            <div class="card shadow border-0 rounded-4 mb-5">
              <div class="card-body p-5">
                ...
                <div class="mb-0">
                  ...
                  <div class="row row-cols-1 row-cols-md-3">
                    <div class="col mb-4 mb-md-0">
                      <div class="d-flex align-items-center bg-light rounded-4 p-3 h-100">Vue</div>
                    </div>
                    <div class="col mb-4 mb-md-0">
